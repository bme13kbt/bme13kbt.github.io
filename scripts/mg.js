...
/***/ function(module, exports, __webpack_require__) {
	...
	var StringController = function (_Controller) {
	  ...
	  function StringController(object, property) {
	    ...
	    _this2.__input.setAttribute('maxlength', '1000');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NumberControllerSlider = function (_NumberController) {
	  ...
	  function NumberControllerSlider(object, property, min, max, step) {
	    ...
	    _dom2.default.bind(_this2.__background, 'touchstart', onMouseDown);
	    ...
	    function onMouseDown(e) {
	      ...
	      _dom2.default.bind(window, 'mousemove', onMouseDrag);
	      _dom2.default.bind(window, 'touchmove', onMouseDrag);
	      _dom2.default.bind(window, 'mouseup', onMouseUp);
	      _dom2.default.bind(window, 'touchend', onMouseUp);
	    ...
	    function onMouseDrag(e) {
	      ...
	      if (e.touches != null) {
	          ...
	          tk = e.touches[0].clientX;
	          //console.log(tk, e.touches);
	      }
	      _this.setValue(map(tk, bgRect.left, bgRect.right, _this.__min, _this.__max));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColorController = function (_Controller) {
	  ...
	  function ColorController(object, property) {
	    ...
	    _dom2.default.bind(_this2.__input, 'click', function () {
	        //console.log("on 2372 click");
	        this.blur();
	    ...
	    closed: {
	      ...
	      set: function set(v) {
	        ...
	        if (_this.__closeButton) {
	            var oval = GUI.TEXT_OPEN;
	            if (_this.domElement.id == "fguipos") oval = "Geometry";
	            if (_this.domElement.id == "guipos") oval = globgeo;
	            _this.__closeButton.innerHTML = v ? oval : GUI.TEXT_CLOSED;
	            lastgeo = _this.__closeButton;
